...
open class ApplicationAssembly: TyphoonAssembly {
     ...
     */
    open dynamic func appDelegate() -> AnyObject {
    ...
    open dynamic func rootViewController() -> AnyObject {
    ...
    open dynamic func citiesListController() -> AnyObject {
    ...
    open dynamic func weatherReportController() -> AnyObject {
    ...
    open dynamic func weatherReportView() -> AnyObject {
    ...
    open dynamic func addCityViewController() -> AnyObject {
