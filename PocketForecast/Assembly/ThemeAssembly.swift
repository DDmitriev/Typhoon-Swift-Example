...
open class ThemeAssembly : TyphoonAssembly {
     ...
     */
    open dynamic func currentTheme() -> AnyObject {
    ...
    */
    open dynamic func themeFactory() -> AnyObject {
    ...
    open dynamic func cloudsOverTheCityTheme() -> AnyObject {
    ...
    open dynamic func lightsInTheRainTheme() -> AnyObject {
        return TyphoonDefinition.withClass(Theme.self) {
            (definition) in
    ...
    open dynamic func beachTheme() -> AnyObject {
        return TyphoonDefinition.withClass(Theme.self) {
            (definition) in
    ...
    open dynamic func sunsetTheme() -> AnyObject {
        return TyphoonDefinition.withClass(Theme.self) {
            (definition) in
